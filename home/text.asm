...
; Dakuten/handakuten handling was removed for the 255-tile expansion. With
; FIRST_REGULAR_TEXT_CHAR raised to $7f, tiles $60-$7e are map graphics rather
; than Japanese characters, so any regular character is now placed directly.
.place
	ld [hli], a
