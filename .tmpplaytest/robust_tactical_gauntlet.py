#!/usr/bin/env python3
"""Run every battle with legal tactical switching in isolated processes."""
...
SINGLE = HERE / "tactical_single_results"
...
def one(index):
    ...
    try:
            ...
            [sys.executable, str(RUNNER), "--single-index", str(index),
             "--tactical-switching"], cwd=HERE.parent,
...
def main():
    ...
    (HERE / "tactical_gauntlet_results.json").write_text(json.dumps(results, indent=2))
