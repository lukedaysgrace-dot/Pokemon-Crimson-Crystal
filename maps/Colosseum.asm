	...
	const COLOSSEUM_GOLD1
	const COLOSSEUM_GOLD2
...
.SetWhichGold:
	...
	iffalse .Gold2
	disappear COLOSSEUM_GOLD2
	appear COLOSSEUM_GOLD1
	return

.Gold2:
	disappear COLOSSEUM_GOLD1
	appear COLOSSEUM_GOLD2
	return
...
Colosseum_MapEvents:
	...
	db 2 ; object events
	object_event  3,  4, SPRITE_GOLD, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CableClubFriendScript, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_1
	object_event  6,  4, SPRITE_GOLD, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CableClubFriendScript, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_2
