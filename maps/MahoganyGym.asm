...
.FightDone:
	checkevent EVENT_GOT_TM16_ICICLE_CRASH
	...
	buttonsound
	verbosegiveitem TM_ICICLE_CRASH
	iffalse MahoganyGym_NoRoomForIcicleCrash
	setevent EVENT_GOT_TM16_ICICLE_CRASH
	writetext PryceText_IcicleCrashSpeech
	waitbutton
	closetext
	end
...
.RematchDone:
	...
	waitbutton
MahoganyGym_NoRoomForIcicleCrash:
	closetext
	end
...
PryceText_IcicleCrashSpeech:
	text "That TM contains"
	line "ICICLE CRASH."

	para "It strikes hard"
	line "and may make the"
...
MahoganyGym_MapEvents:
	...
	object_event  4,  6, SPRITE_SKIER_NEW, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerSkierRoxanne, -1
	object_event  0, 17, SPRITE_SNOWBOARDER_NEW, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerBoarderRonald, -1
	object_event  9, 17, SPRITE_SKIER_NEW, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 1, TrainerSkierClarissa, -1
	object_event  5,  9, SPRITE_SNOWBOARDER_NEW, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerBoarderBrad, -1
	object_event  2,  4, SPRITE_SNOWBOARDER_NEW, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerBoarderDouglas, -1
