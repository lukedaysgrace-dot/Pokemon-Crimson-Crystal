...
GOLDENRODGAMECORNER_BAGON_COINS     EQU 3500
GOLDENRODGAMECORNER_DEINO_COINS     EQU 4000
GOLDENRODGAMECORNER_MUNCHLAX_COINS  EQU 1500
GOLDENRODGAMECORNER_DRATINI_COINS   EQU 3000
GOLDENRODGAMECORNER_PORYGON_COINS   EQU 7000
...
.Munchlax:
	checkcoins GOLDENRODGAMECORNER_MUNCHLAX_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	...
	writetext GoldenrodGameCornerPrizeVendorHereYouGoText
	waitbutton
	loadmonindex 3, MUNCHLAX
	special GameCornerPrizeMonCheckDex
	givepoke MUNCHLAX, 15
	takecoins GOLDENRODGAMECORNER_MUNCHLAX_COINS
	sjump .loop
