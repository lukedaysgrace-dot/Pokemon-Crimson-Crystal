...
RockTunnel1F_MapEvents:
	...
	object_event 10, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RockTunnel1FTMPowerGem, EVENT_ROCK_TUNNEL_1F_TM_POWER_GEM
