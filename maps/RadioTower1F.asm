...
RadioTower1F_MapEvents:
	...
	object_event 14,  1, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerGruntF6, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
