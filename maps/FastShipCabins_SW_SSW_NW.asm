...
FastShipCabins_SW_SSW_NW_MapEvents:
	...
	db 4 ; object events
	object_event  1, 15, SPRITE_FIREBREATHER_NEW, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerFirebreatherLyle, EVENT_FAST_SHIP_PASSENGERS_FIRST_TRIP
