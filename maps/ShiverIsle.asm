	...
	const SHIVERISLE_ICE_STONE
	const SHIVERISLE_BOARDER_AIDAN
	const SHIVERISLE_BOARDER_NOEL
	const SHIVERISLE_SKIER_BIANCA

ShiverIsle_MapScripts:
	db 0 ; scene scripts
...
ShiverIsle_MapEvents:
	...
	db 4 ; object events
	object_event 15,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, ShiverIsleIceStone, EVENT_SHIVER_ISLE_ICE_STONE
	object_event  4,  5, SPRITE_SNOWBOARDER_NEW, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, TrainerBoarderAidan, -1
	object_event 14, 10, SPRITE_SNOWBOARDER_NEW, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 5, TrainerBoarderNoel, -1
	object_event  6, 15, SPRITE_SKIER_NEW, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 5, TrainerSkierBianca, -1
