...
; The Aerodactyl, Ho-Oh, Kabuto and Omanyte word rooms add blocks $40-$41 (the
; crumbling fossil walls), so they need their own collision tables instead of
; sharing the beta one, which only covers blocks $00-$3f.
...
INCLUDE "data/tilesets/kabuto_word_room_collision.asm"
