...
; The old font_extra glyphs ($60-$78) and textbox frames ($79-$7e) have been
; relocated into the main font (see the $ba-$de range below) so that tiles
; $60-$7e can be used for map graphics (255-tile expansion). Only the space
; character remains here.

	charmap " ",         $7f ; gfx/frames/space.png

; Actual characters (from gfx/font/font_battle_extra.png)
; (kept: these load into $6e-$74 only on full-screen menu/battle screens,
;  which never display map tiles, so they don't conflict with map graphics)
...
; Actual characters (from other graphics files)
	...
	; ■/▲/☎ and the prime marks ′/″ have been relocated to the main font
	; ($d7-$d9 and $ce-$cf below) for the 255-tile expansion.
