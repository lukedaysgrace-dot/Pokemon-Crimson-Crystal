...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_PC_CURSOR,                SPRITE_ANIM_SEQ_PC_CURSOR,               $00 ; SPRITE_ANIM_INDEX_PC_CURSOR
	db SPRITE_ANIM_FRAMESET_PC_QUICK,                 SPRITE_ANIM_SEQ_PC_QUICK,                $00 ; SPRITE_ANIM_INDEX_PC_QUICK
	db SPRITE_ANIM_FRAMESET_PC_MODE,                  SPRITE_ANIM_SEQ_PC_MODE,                 $00 ; SPRITE_ANIM_INDEX_PC_MODE
	db SPRITE_ANIM_FRAMESET_PC_MODE2,                 SPRITE_ANIM_SEQ_PC_MODE,                 $00 ; SPRITE_ANIM_INDEX_PC_MODE2
	db SPRITE_ANIM_FRAMESET_PC_PACK,                  SPRITE_ANIM_SEQ_PC_PACK,                 $00 ; SPRITE_ANIM_INDEX_PC_PACK
