...
MapGroup_Violet:
	...
	map SilentCrypt, TILESET_JOHTO, CAVE, ROUTE_37, MUSIC_SILENT_CRYPT, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map GravekeepersHouse, TILESET_HOUSE, INDOOR, ROUTE_37, MUSIC_LAVENDER, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cianwood:
	...
	map IceIsland, TILESET_ICE_PATH, CAVE, ROUTE_41, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
