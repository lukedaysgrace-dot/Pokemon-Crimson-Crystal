...
MapGroup_Violet:
	...
	map SilentCrypt, TILESET_JOHTO, CAVE, ROUTE_37, MUSIC_LAVENDER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodPowerPlant, TILESET_FACILITY, INDOOR, GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodPowerPlantB1F, TILESET_FACILITY, DUNGEON, GOLDENROD_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
