...
MapGroup_Cinnabar:
	...
	map FireIsland, TILESET_ELITE_FOUR_ROOM, CAVE, FIRE_ISLAND, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map ThunderIsland, TILESET_FACILITY, CAVE, THUNDER_ISLAND, MUSIC_ROCKET_HIDEOUT, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map IceIsland, TILESET_ICE_PATH, CAVE, ICE_ISLAND, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
...
MapGroup_Cianwood:
	...
	map ShiverIsle, TILESET_ICE_PATH, CAVE, SHIVER_ISLE, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_DRATINI
