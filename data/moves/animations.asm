...
BattleAnimations::
	...
	banim BattleAnim_MudBomb ; MUD_BOMB
	banim BattleAnim_Revenge ; REVENGE
	banim BattleAnim_RockWrecker ; ROCK_WRECKER
	banim BattleAnim_IronDefense ; IRON_DEFENSE
	banim BattleAnim_BulletSeed ; BULLET_SEED
	banim BattleAnim_Inferno ; INFERNO
	banim BattleAnim_WoodHammer ; WOOD_HAMMER
	banim BattleAnim_Payback ; PAYBACK
	banim BattleAnim_HiHorsepower ; HIHORSEPOWER
	banim BattleAnim_MudShot ; MUD_SHOT
	banim BattleAnim_SandTomb ; SAND_TOMB
	banim BattleAnim_LowSweep ; LOW_SWEEP
	banim BattleAnim_CrossPoison ; CROSS_POISON
	banim BattleAnim_SmartStrike ; SMART_STRIKE
	banim BattleAnim_Belch ; BELCH
	banim BattleAnim_Nuzzle ; NUZZLE
	banim BattleAnim_CrushClaw ; CRUSH_CLAW
	banim BattleAnim_OdorSleuth ; ODOR_SLEUTH
	banim BattleAnim_Howl ; HOWL
	banim BattleAnim_PsychoCut ; PSYCHO_CUT
	banim BattleAnim_DualChop ; DUAL_CHOP
	banim BattleAnim_RockPolish ; ROCK_POLISH
	banim BattleAnim_DoubleHitM ; DOUBLE_HIT_M
	banim BattleAnim_BlazeKick ; BLAZE_KICK
	banim BattleAnim_SheerCold ; SHEER_COLD
	banim BattleAnim_EchoedVoice ; ECHOED_VOICE
	banim BattleAnim_NeedleArm ; NEEDLE_ARM
	banim BattleAnim_GrassWhistle ; GRASSWHISTLE
	banim BattleAnim_OminousWind ; OMINOUS_WIND
	banim BattleAnim_FrenzyPlant ; FRENZY_PLANT
	banim BattleAnim_BlastBurn ; BLAST_BURN
	banim BattleAnim_HydroCannon ; HYDRO_CANNON
	banim BattleAnim_WaveCrash ; WAVE_CRASH
	banim BattleAnim_FakeOut ; FAKE_OUT
	banim BattleAnim_HeadlongRush ; HEADLONGRUSH
	banim BattleAnim_DualWingbeat ; DUALWINGBEAT
	banim BattleAnim_TwinBeam ; TWIN_BEAM
	banim BattleAnim_Psyshield ; PSYSHIELD
	banim BattleAnim_MeteorMash ; METEOR_MASH
	banim BattleAnim_ForcePalm ; FORCE_PALM
	banim BattleAnim_SkyUppercut ; SKY_UPPERCUT
	banim BattleAnim_HeadSmash ; HEAD_SMASH
	banim BattleAnim_RagingFury ; RAGING_FURY
	banim BattleAnim_StrangeSteam ; STRANGESTEAM
	banim BattleAnim_ShadowBone ; SHADOW_BONE
	banim BattleAnim_PoisonTail ; POISON_TAIL
	banim BattleAnim_FreezeGlare ; FREEZE_GLARE
	banim BattleAnim_FieryWrath ; FIERY_WRATH
	banim BattleAnim_ShellSideArm ; SHELLSIDEARM
	banim BattleAnim_MeteoAssault ; METEOASSAULT
	banim BattleAnim_CosmicPower ; COSMIC_POWER
	banim BattleAnim_StrengthSap ; STRENGTH_SAP
	banim BattleAnim_HammerArm ; HAMMER_ARM
	banim BattleAnim_Superpower ; SUPERPOWER
	banim BattleAnim_PowerUpPunch ; POWERUPPUNCH
	banim BattleAnim_BrickBreak ; BRICK_BREAK
	banim BattleAnim_QuiverDance ; QUIVER_DANCE
	banim BattleAnim_AcidSpray ; ACID_SPRAY
	banim BattleAnim_PlayNice ; PLAY_NICE
	banim BattleAnim_CircleThrow ; CIRCLE_THROW
	banim BattleAnim_Bounce ; BOUNCE
	banim BattleAnim_ChargeBeam ; CHARGE_BEAM
	banim BattleAnim_DragonTail ; DRAGON_TAIL
	banim BattleAnim_GrassKnot ; GRASS_KNOT
	banim BattleAnim_WorkUp ; WORK_UP
	banim BattleAnim_Flatter ; FLATTER
	banim BattleAnim_AquaRing ; AQUA_RING
	banim BattleAnim_Coil ; COIL
	banim BattleAnim_PsychoBoost ; PSYCHO_BOOST
	banim BattleAnim_EerieSpell ; EERIE_SPELL
	banim BattleAnim_ClearSmog ; CLEAR_SMOG
	banim BattleAnim_RagingBull ; RAGING_BULL
	banim BattleAnim_DireClaw ; DIRE_CLAW
	banim BattleAnim_PhantomForce ; PHANTOMFORCE
	banim BattleAnim_SacredSword ; SACRED_SWORD
	...
	banim BattleAnim_FaintAttack ; FOUL_PLAY
	banim BattleAnim_SpiderWeb ; STICKY_WEB
	banim BattleAnim_TwinBeam ; DRAGON_DARTS
	banim BattleAnim_DragonRush ; GLAIVE_RUSH
	banim BattleAnim_Protect ; BANEFUL_BUNKER
	banim BattleAnim_RagingFury ; RAGE_FIST
	banim BattleAnim_Inferno ; ARMOR_CANNON
	banim BattleAnim_FieryWrath ; FIERY_DANCE
	...
	banim BattleAnim_HeatWave ; HEAT_WAVE
...
.loop
	...
	anim_wait 8
	anim_obj ANIM_OBJ_GLIMMER, 128, 48, $18
	anim_wait 16
	anim_ret
