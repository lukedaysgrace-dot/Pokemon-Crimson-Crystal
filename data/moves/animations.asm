...
BattleAnimations::
	...
	banim BattleAnim_Overheat ; OVERHEAT
	banim BattleAnim_LeafStorm ; LEAF_STORM
	banim BattleAnim_FakeOut ; FAKE_OUT
	banim BattleAnim_FlipTurn ; FLIP_TURN
	...
	banim BattleAnim_ScaleShot ; SCALE_SHOT
	...
	banim BattleAnim_BarbBarrage ; BARB_BARRAGE
	banim BattleAnim_InfernalParade ; INFERNAL_PARADE
	banim BattleAnim_KowtowCleave ; KOWTOW_CLEAVE
	banim BattleAnim_ArmorCannon ; ARMOR_CANNON
	banim BattleAnim_ShellSideArm ; SHELLSIDEARM
	banim BattleAnim_GlaiveRush ; GLAIVE_RUSH
	banim BattleAnim_DragonDarts ; DRAGON_DARTS
	banim BattleAnim_AppleAcid ; APPLE_ACID
	banim BattleAnim_GravApple ; GRAV_APPLE
	...
	banim BattleAnim_BanefulBunker ; BANEFUL_BUNKER
	banim BattleAnim_RagingBull ; RAGING_BULL
	banim BattleAnim_FickleBeam ; FICKLE_BEAM
	banim BattleAnim_StoneAxe ; STONE_AXE
	banim BattleAnim_QuiverDance ; QUIVER_DANCE
	banim BattleAnim_StealthRock ; STEALTH_ROCK
	banim BattleAnim_Defog ; DEFOG
	banim BattleAnim_BodyPress ; BODY_PRESS
	banim BattleAnim_WorkUp ; WORK_UP
	banim BattleAnim_Superpower ; SUPERPOWER
	banim BattleAnim_FieryDance ; FIERY_DANCE
	banim BattleAnim_FoulPlay ; FOUL_PLAY
	banim BattleAnim_RageFist ; RAGE_FIST
	...
	banim BattleAnim_FreezeDry ; FREEZE_DRY
