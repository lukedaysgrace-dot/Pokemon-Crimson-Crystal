...
BattleAnimations::
	...
	banim BattleAnim_Overheat_CC ; OVERHEAT
	banim BattleAnim_LeafStorm_CC ; LEAF_STORM
	banim BattleAnim_FakeOut_CC ; FAKE_OUT
	banim BattleAnim_FlipTurn_CC ; FLIP_TURN
	banim BattleAnim_IronDefense_CC ; IRON_DEFENSE
	banim BattleAnim_RockPolish_CC ; ROCK_POLISH
	banim BattleAnim_WoodHammer_CC ; WOOD_HAMMER
	banim BattleAnim_HeadSmash_CC ; HEAD_SMASH
	banim BattleAnim_DrillRun_CC ; DRILL_RUN
	banim BattleAnim_PsychoCut_CC ; PSYCHO_CUT
	banim BattleAnim_SacredSword_CC ; SACRED_SWORD
	banim BattleAnim_BrickBreak_CC ; BRICK_BREAK
	banim BattleAnim_HeatWave_CC ; HEAT_WAVE
	banim BattleAnim_Snarl_CC ; SNARL
	banim BattleAnim_Nuzzle_CC ; NUZZLE
	banim BattleAnim_BulletSeed_CC ; BULLET_SEED
	banim BattleAnim_DualWingbeat_CC ; DUALWINGBEAT
	banim BattleAnim_RockTomb_CC ; ROCK_TOMB
	banim BattleAnim_LowSweep_CC ; LOW_SWEEP
	banim BattleAnim_MudShot_CC ; MUD_SHOT
	banim BattleAnim_AirCutter_CC ; AIR_CUTTER
	banim BattleAnim_CrossPoison_CC ; CROSS_POISON
	banim BattleAnim_MagicalLeaf_CC ; MAGICAL_LEAF
	banim BattleAnim_SignalBeam_CC ; SIGNAL_BEAM
	banim BattleAnim_ScaleShot_CC ; SCALE_SHOT
	banim BattleAnim_PhantomForce_CC ; PHANTOMFORCE
	banim BattleAnim_HeadlongRush_CC ; HEADLONGRUSH
	banim BattleAnim_ShadowBone_CC ; SHADOW_BONE
	banim BattleAnim_DireClaw_CC ; DIRE_CLAW
	banim BattleAnim_BarbBarrage_CC ; BARB_BARRAGE
	banim BattleAnim_InfernalParade_CC ; INFERNAL_PARADE
	banim BattleAnim_KowtowCleave_CC ; KOWTOW_CLEAVE
	banim BattleAnim_ArmorCannon_CC ; ARMOR_CANNON
	banim BattleAnim_ShellSideArm_CC ; SHELLSIDEARM
	banim BattleAnim_GlaiveRush_CC ; GLAIVE_RUSH
	banim BattleAnim_DragonDarts_CC ; DRAGON_DARTS
	banim BattleAnim_AppleAcid_CC ; APPLE_ACID
	banim BattleAnim_GravApple_CC ; GRAV_APPLE
	banim BattleAnim_PsyshieldBash_CC ; PSYSHIELD
	banim BattleAnim_RagingFury_CC ; RAGING_FURY
	banim BattleAnim_StrangeSteam_CC ; STRANGESTEAM
	banim BattleAnim_EerieSpell_CC ; EERIE_SPELL
	banim BattleAnim_BanefulBunker_CC ; BANEFUL_BUNKER
	banim BattleAnim_RagingBull_CC ; RAGING_BULL
	banim BattleAnim_FickleBeam_CC ; FICKLE_BEAM
	banim BattleAnim_StoneAxe_CC ; STONE_AXE
	banim BattleAnim_QuiverDance_CC ; QUIVER_DANCE
	banim BattleAnim_StealthRock_CC ; STEALTH_ROCK
	banim BattleAnim_Defog_CC ; DEFOG
	banim BattleAnim_BodyPress_CC ; BODY_PRESS
	banim BattleAnim_WorkUp_CC ; WORK_UP
	banim BattleAnim_Superpower_CC ; SUPERPOWER
	banim BattleAnim_FieryDance_CC ; FIERY_DANCE
	banim BattleAnim_FoulPlay_CC ; FOUL_PLAY
	banim BattleAnim_RageFist_CC ; RAGE_FIST
	banim BattleAnim_CrushClaw_CC ; CRUSH_CLAW
	banim BattleAnim_ForcePalm_CC ; FORCE_PALM
	banim BattleAnim_HammerArm_CC ; HAMMER_ARM
	banim BattleAnim_CircleThrow_CC ; CIRCLE_THROW
