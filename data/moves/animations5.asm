...
; Exact Weather Ball animation from mae-pokeorange. The Ice Ball burst helper
; is copied below under a bank-local name.
BattleAnim_WeatherBall_PO:
...
.ice
	...
	anim_sound 0, 0, SFX_METRONOME
	anim_wait 64
	anim_call BattleAnim_WeatherBallIceBurst_PO
	anim_wait 16
	anim_ret

BattleAnim_WeatherBallIceBurst_PO:
	anim_sound 0, 1, SFX_SHINE
	anim_obj ANIM_OBJ_HIT_YFIX, 136, 48, $0
	anim_obj ANIM_OBJ_ICE_SPLASH, 136, 56, $28
