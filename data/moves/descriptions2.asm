; Descriptions for moves added on top of the original table.
MoveDescriptions2:
...
OverheatDescription:
	...
	next "that cuts SP.ATK.@"

LeafStormDescription:
	db   "A leaf storm that"
	next "cuts SP.ATK.@"
