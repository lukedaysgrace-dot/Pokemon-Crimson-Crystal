	...
	tilecoll WALL, TALL_GRASS, WALL, TALL_GRASS ; 88
	tilecoll TALL_GRASS, WALL, TALL_GRASS, WALL ; 89
	tilecoll WALL, WALL, FLOOR, WALL ; 8a
	tilecoll FLOOR, WALL, WALL, WALL ; 8b
	tilecoll WALL, TALL_GRASS, TALL_GRASS, TALL_GRASS ; 8c
	tilecoll WALL, FLOOR, FLOOR, FLOOR ; 8d
	tilecoll WALL, WARP_CARPET_UP, WALL, FLOOR ; 8e
	tilecoll WARP_CARPET_UP, WALL, WALL, WALL ; 8f
	tilecoll WALL, FLOOR, WALL, WARP_CARPET_DOWN ; 90
	tilecoll FLOOR, FLOOR, WARP_CARPET_DOWN, WARP_CARPET_DOWN ; 91
	tilecoll FLOOR, WALL, WARP_CARPET_DOWN, WALL ; 92
