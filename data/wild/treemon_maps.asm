...
TreeMonMaps:
	treemon_map ROUTE_26,                  TREEMON_SET_KANTO_LATE
	treemon_map ROUTE_27,                  TREEMON_SET_KANTO_LATE
	treemon_map ROUTE_28,                  TREEMON_SET_CITY_LATE
	...
	treemon_map ROUTE_38,                  TREEMON_SET_ROUTE_MID
	treemon_map ROUTE_39,                  TREEMON_SET_ROUTE_MID
	treemon_map ROUTE_40,                  TREEMON_SET_CITY_MID
	treemon_map ROUTE_41,                  TREEMON_SET_CITY_MID
	treemon_map ROUTE_42,                  TREEMON_SET_TOWN_MID
	treemon_map ROUTE_43,                  TREEMON_SET_LAKE
	treemon_map ROUTE_44,                  TREEMON_SET_CANYON_LATE
	treemon_map ROUTE_45,                  TREEMON_SET_CANYON_LATE
	...
	treemon_map CIANWOOD_CITY,             TREEMON_SET_CITY_MID
	treemon_map GOLDENROD_CITY,            TREEMON_SET_CITY
	treemon_map OLIVINE_CITY,              TREEMON_SET_CITY_MID
	treemon_map ECRUTEAK_CITY,             TREEMON_SET_CITY_MID
	treemon_map MAHOGANY_TOWN,             TREEMON_SET_CITY_MID
	treemon_map LAKE_OF_RAGE,              TREEMON_SET_LAKE
	treemon_map BLACKTHORN_CITY,           TREEMON_SET_CITY_MID
	treemon_map SILVER_CAVE_OUTSIDE,       TREEMON_SET_CITY_LATE
