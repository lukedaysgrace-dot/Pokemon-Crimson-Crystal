	...
	abilities_for SLOWKING_GALARIAN, OWN_TEMPO, UNAWARE, REGENERATOR
	db 0 ; padding
	db GROWTH_MEDIUM_FAST ; growth rate
	dn EGG_MONSTER, EGG_WATER_1 ; egg groups

	; tm/hm learnset
	tmhm DRAIN_PUNCH, HEADBUTT, CURSE, TOXIC, ZAP_CANNON, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, BLIZZARD, HYPER_BEAM, PROTECT, RAIN_DANCE, IRON_HEAD, EARTHQUAKE, RETURN, DIG, SHADOW_BALL, SWAGGER, ICE_PUNCH, SLUDGE_BOMB, FIRE_BLAST, SWIFT, NASTY_PLOT, REST, ATTRACT, ZEN_HEADBUTT, POWER_GEM, WEATHER_BALL, SURF, STRENGTH, FLASH, WHIRLPOOL, WATERFALL, FLAMETHROWER, ICE_BEAM
	; end
