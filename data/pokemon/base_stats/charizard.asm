	...
	; tm/hm learnset
	tmhm DRAIN_PUNCH, HEADBUTT, CURSE, ROAR, TOXIC, ROCK_SMASH, DRAGON_PULSE, HIDDEN_POWER, SUNNY_DAY, WORK_UP, HYPER_BEAM, PROTECT, WILL_O_WISP, FACADE, IRON_HEAD, DRAGON_CLAW, EARTHQUAKE, RETURN, DIG, MUD_SLAP, SWAGGER, SANDSTORM, FIRE_BLAST, SWIFT, DRAGON_DANCE, REST, ATTRACT, STEEL_WING, FIRE_PUNCH, BUG_BITE, HONE_CLAWS, WEATHER_BALL, CUT, FLY, STRENGTH, FLAMETHROWER
	; end
