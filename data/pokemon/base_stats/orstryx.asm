	...
	db 5 ; unknown 2
	INCBIN "gfx/pokemon/orstryx/front.dimensions"
	; custom mon (Psychic/Flying legendary flavor) - change freely
	abilities_for ORSTRYX, PRESSURE, KEEN_EYE, MAGIC_BOUNCE
	db 0 ; padding
