...
; entries correspond to constants/pokemon_constants.asm
	...
	mon_cry CRY_NIDOQUEEN,    64,   320 ; ANNIHILAPE
	mon_cry CRY_DUNSPARCE,    32,   256 ; DRUNSPARCE
	mon_cry CRY_VOLTORB,      32,   384 ; ELECTIVIRE
	mon_cry CRY_GIRAFARIG,    32,   320 ; FARIGIRAF
	mon_cry CRY_VENONAT,     -64,   256 ; GLACEON
	mon_cry CRY_GLIGAR,       32,   320 ; GLISCOR
	mon_cry CRY_MARILL,      -32,   320 ; HONCHKROW
	mon_cry CRY_VENONAT,      32,   256 ; LEAFEON
	mon_cry CRY_SEEL,         32,   320 ; LICKILICKY
	mon_cry CRY_CHARMANDER,   32,   384 ; MAGMORTAR
	mon_cry CRY_METAPOD,      64,   384 ; MAGNEZONE
	mon_cry CRY_MAGCARGO,     32,   384 ; MAMOSWINE
	mon_cry CRY_DROWZEE,     -64,   320 ; MESMERIA (higher pitch Jynx)
	mon_cry CRY_HOOTHOOT,     32,   320 ; MISMAGIUS
	mon_cry CRY_WEEPINBELL,   64,   320 ; PORYGON_Z
	mon_cry CRY_GOLEM,        32,   320 ; TANGROWTH
	mon_cry CRY_TEDDIURSA,    32,   384 ; URSALUNA
	mon_cry CRY_WOOPER,       32,   320 ; WEAVILE
	mon_cry CRY_TOTODILE,     32,   256 ; YANMEGA
	mon_cry CRY_RAIKOU,        0,   256 ; BAGON
	mon_cry CRY_SPINARAK,      0,   320 ; SHELGON
	mon_cry CRY_CHARMANDER,   32,   384 ; SALAMENCE
	mon_cry CRY_METAPOD,      32,   256 ; RALTS
	mon_cry CRY_METAPOD,      32,   320 ; KIRLIA
	mon_cry CRY_METAPOD,      32,   384 ; GARDEVOIR
	mon_cry CRY_SPINARAK,     64,   256 ; VENIPEDE
	mon_cry CRY_SPINARAK,     32,   320 ; WHIRLIPEDE
	mon_cry CRY_SPINARAK,    -32,   384 ; SCOLIPEDE
	mon_cry CRY_AIPOM,        32,   320 ; WYRDEER
	mon_cry CRY_RHYDON,       32,   384 ; RHYPERIOR
	mon_cry CRY_TOGEPI,       64,   256 ; TOGEKISS
