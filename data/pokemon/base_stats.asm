...
_tms3 = 0 ; TM49-TM54 + HM01-HM07 + MT01-MT03 (16/16)
rept _NARG
	if DEF(\1_TMNUM)
	if \1_TMNUM < 24 + 1
...
_tms2 = _tms2 >> 8
endr
rept 2 ; TM49-TM54 + HM01-HM07 + MT01-MT03 (16/16)
	db _tms3 & $ff
_tms3 = _tms3 >> 8
endr
ENDM
...
INCLUDE "data/pokemon/base_stats/drunsparce.asm"
...
INCLUDE "data/pokemon/base_stats/dipplin.asm"
INCLUDE "data/pokemon/base_stats/appletun.asm"
INCLUDE "data/pokemon/base_stats/flapple.asm"
INCLUDE "data/pokemon/base_stats/hydrapple.asm"
INCLUDE "data/pokemon/base_stats/duraludon.asm"
INCLUDE "data/pokemon/base_stats/archaludon.asm"
...
INCLUDE "data/pokemon/base_stats/teddiursabm.asm"
INCLUDE "data/pokemon/base_stats/ursaringbm.asm"
INCLUDE "data/pokemon/base_stats/ursalunabm.asm"
...
INCLUDE "data/pokemon/base_stats/cetoddle.asm"
INCLUDE "data/pokemon/base_stats/cetitan.asm"
...
INCLUDE "data/pokemon/base_stats/watu.asm"
