...
MonMenuIcons:
	...
	db ICON_MONSTER     ; ANNIHILAPE
	db ICON_MONSTER     ; BAGON
	db ICON_MONSTER     ; DRUNSPARCE
	db ICON_MONSTER     ; ELECTIVIRE
	db ICON_MONSTER     ; FARIGIRAF
	...
	db ICON_MONSTER     ; MAGNEZONE
	db ICON_MONSTER     ; MAMOSWINE
	db ICON_MONSTER     ; MESMERIA
	db ICON_MONSTER     ; MISMAGIUS
	db ICON_MONSTER     ; PORYGON_Z
	db ICON_MONSTER     ; RALTS
	db ICON_MONSTER     ; RHYPERIOR
	db ICON_MONSTER     ; SALAMENCE
	db ICON_MONSTER     ; SCOLIPEDE
	db ICON_MONSTER     ; SHELGON
	db ICON_MONSTER     ; TANGROWTH
	db ICON_MONSTER     ; TOGEKISS
	db ICON_MONSTER     ; URSALUNA
	db ICON_MONSTER     ; VENIPEDE
	db ICON_MONSTER     ; WEAVILE
	db ICON_MONSTER     ; WHIRLIPEDE
	db ICON_MONSTER     ; WYRDEER
	db ICON_MONSTER     ; YANMEGA
	...
	db ICON_MONSTER     ; HYDREIGON
	db ICON_MONSTER     ; DREEPY
	db ICON_MONSTER     ; DRAKLOAK
	db ICON_MONSTER     ; DRAGAPULT
	db ICON_MONSTER     ; IMPIDIMP
	db ICON_MONSTER     ; MORGREM
	db ICON_MONSTER     ; GRIMMSNARL
	db ICON_CLEFAIRY    ; TINKATINK
	db ICON_CLEFAIRY    ; TINKATUFF
	db ICON_CLEFAIRY    ; TINKATON
	db ICON_MONSTER     ; FRIGIBAX
	db ICON_MONSTER     ; ARCTIBAX
	db ICON_MONSTER     ; BAXCALIBUR
	db ICON_CHARMANDER  ; CHARCADET
	db ICON_CHARMANDER  ; ARMAROGUE
	db ICON_CHARMANDER  ; CERULEDGE
