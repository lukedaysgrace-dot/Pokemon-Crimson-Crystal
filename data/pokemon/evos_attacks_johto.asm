...
SECTION "Evolutions and Attacks 2C", ROMX

EvosAttacksPointers2C::
...
GurdurrEvosAttacks:
	dbbw EVOLVE_LEVEL, 36, CONKELDURR
	db 0 ; no more evolutions
	dbw 1, LEER
	dbw 1, LOW_KICK
	dbw 1, POUND
...
LarvestaEvosAttacks:
	dbbw EVOLVE_LEVEL, 35, VOLCARONA
	db 0 ; no more evolutions
	dbw 1, EMBER
	dbw 1, STRING_SHOT
	dbw 6, FLAME_CHARGE
...
ZweilousEvosAttacks:
	dbbw EVOLVE_LEVEL, 45, HYDREIGON
	db 0 ; no more evolutions
	dbw 1, BITE
	dbw 1, DRAGONBREATH
	dbw 1, FOCUS_ENERGY
...
DuraludonEvosAttacks:
	dbbw EVOLVE_LEVEL, 40, ARCHALUDON
	db 0 ; no more evolutions
	dbw 1, LEER
	dbw 1, METAL_CLAW
	dbw 6, ROCK_SMASH
...
FletchlingEvosAttacks:
	dbbw EVOLVE_LEVEL, 17, FLETCHINDER
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, PECK
	dbw 5, QUICK_ATTACK
...
SizzlipedeEvosAttacks:
	dbbw EVOLVE_LEVEL, 28, CENTISKORCH
	db 0 ; no more evolutions
	dbw 1, EMBER
	dbw 1, SMOKESCREEN
	dbw 6, WRAP
...
SnoverEvosAttacks:
	dbbw EVOLVE_LEVEL, 36, ABOMASNOW
	db 0 ; no more evolutions
	dbw 1, LEER
	dbw 1, POWDER_SNOW
	dbw 5, RAZOR_LEAF
...
WimpodEvosAttacks:
	dbbw EVOLVE_LEVEL, 25, GOLISOPOD
	db 0 ; no more evolutions
	dbw 1, DEFENSE_CURL
	dbw 1, SAND_ATTACK
	dbw 1, STRUGGLE_BUG
...
BisharpEvosAttacks:
	dbbw EVOLVE_LEVEL, 40, KINGAMBIT
	db 0 ; no more evolutions
	dbw 1, FURY_CUTTER
	dbw 1, LEER
	dbw 1, METAL_CLAW
...
MeowthAlolanEvosAttacks:
	dbbw EVOLVE_LEVEL, 28, PERSIAN_ALOLAN
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, SCRATCH
	dbw 6, BITE
...
GravelerAlolanEvosAttacks:
	dbbw EVOLVE_LEVEL, 36, GOLEM_ALOLAN
	db 0 ; no more evolutions
	dbw 1, DEFENSE_CURL
	dbw 1, TACKLE
	dbw 4, SANDSTORM
...
PonytaGalarianEvosAttacks:
	dbbw EVOLVE_LEVEL, 40, RAPIDASH_GALARIAN
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, TACKLE
	dbw 4, TAIL_WHIP
