...
GurdurrEvosAttacks:
	dbbw EVOLVE_LEVEL, 40, CONKELDURR
	db 0 ; no more evolutions
	dbw 1, POUND
	dbw 1, LEER
	dbw 8, LOW_KICK
...
ArctibaxEvosAttacks:
	dbbw EVOLVE_LEVEL, 54, BAXCALIBUR
	db 0 ; no more evolutions
	dbw 1, TACKLE
	dbw 1, LEER
	dbw 7, BITE
...
DipplinEvosAttacks:
	dbbw EVOLVE_LEVEL, 50, HYDRAPPLE
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, TACKLE
	dbw 8, ABSORB
...
DuraludonEvosAttacks:
	dbbw EVOLVE_LEVEL, 50, ARCHALUDON
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, TACKLE
	dbw 12, METAL_CLAW
...
WimpodEvosAttacks:
	dbbw EVOLVE_LEVEL, 30, GOLISOPOD
	db 0 ; no more evolutions
	dbw 1, GROWL
	dbw 1, TACKLE
	dbw 8, STRING_SHOT
