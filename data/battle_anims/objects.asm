...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_84, BATTLEANIMFUNC_02, PAL_BATTLE_OB_BLUE, ANIM_GFX_AURA_SPHERE ; ANIM_OBJ_AURA_SPHERE
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_AVALANCHE_ICE_BIG, BATTLEANIMFUNC_RADIAL_MOVE_OUT, PAL_BATTLE_OB_BLUE, ANIM_GFX_ICE ; ANIM_OBJ_AVALANCHE_BIG
