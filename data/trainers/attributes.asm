...
; Falkner
	...
	db 25 ; base reward
	dw AI_BASIC | AI_SETUP | AI_TYPES | AI_SMART | AI_OPPORTUNIST | AI_AGGRESSIVE | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_ABILITIES | AI_ELITE
	dw CONTEXT_USE | SWITCH_SOMETIMES | SWITCH_ABILITIES
...
; Cooltrainerm
	db NO_ITEM, NO_ITEM ; items
	db 12 ; base reward
	dw AI_BASIC | AI_SETUP | AI_SMART | AI_AGGRESSIVE | AI_CAUTIOUS | AI_STATUS | AI_RISKY | AI_ABILITIES
	dw CONTEXT_USE | SWITCH_SOMETIMES | SWITCH_ABILITIES
...
; Super Nerd
	db NO_ITEM, NO_ITEM ; items
	db 8 ; base reward
	dw AI_BASIC | AI_TYPES | AI_SMART | AI_STATUS | AI_ABILITIES
	dw CONTEXT_USE | SWITCH_SOMETIMES
...
; Ninja
	db NO_ITEM, NO_ITEM ; items
	db 20 ; base reward
	dw AI_BASIC | AI_SETUP | AI_TYPES | AI_SMART | AI_STATUS | AI_RISKY | AI_ABILITIES
	dw CONTEXT_USE | SWITCH_SOMETIMES
