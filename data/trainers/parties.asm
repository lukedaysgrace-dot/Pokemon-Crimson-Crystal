...
BugsyGroup:
	...
	db 14, SPINARAK,  NO_ITEM,      PIN_MISSILE, ACID, MEGA_DRAIN, NIGHT_SHADE
	db 15, LEDIAN,  NO_ITEM,      THUNDERPUNCH, KARATE_CHOP, SUPERSONIC, LEECH_LIFE
	db 16, SCYTHER, BERRY_JUICE,   QUICK_ATTACK, FURY_CUTTER, CUT, PURSUIT
	db -1 ; end

	; BUGSY (2): Rematch
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 54, LEDIAN,      FOCUS_BAND,   GIGA_DRAIN, TWINEEDLE, RAZOR_WIND, CROSS_CHOP
