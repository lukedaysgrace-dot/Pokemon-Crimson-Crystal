; battle_anim_struct members (see macros/wram.asm)
	...
	const BATTLEANIMSTRUCT_FRAMESET_ID_HI ; was unused BATTLEANIMSTRUCT_17
...
; BattleAnimObjects indexes (see data/battle_anims/objects.asm)
	...
	const ANIM_OBJ_BLOOD_MOON_CHARGE
...
; objects ported from polishedcrystal (batch 2)
	const ANIM_OBJ_ACID
...
; functions ported from polishedcrystal (batch 2)
...
; BattleAnimFrameData indexes (see data/battle_anims/framesets.asm)
	...
	const BATTLEANIMFRAMESET_PC_BOUNCING_MUSHROOM
	...
	const BATTLEANIMFRAMESET_PC_BRICK_BREAK
	...
	const BATTLEANIMFRAMESET_PC_CLAW_TEAR
	...
	const BATTLEANIMFRAMESET_PC_GROWING_BALL
	const BATTLEANIMFRAMESET_STAT_UP
	const BATTLEANIMFRAMESET_STAT_DOWN
	const BATTLEANIMFRAMESET_PC_ICE_LONG
	const BATTLEANIMFRAMESET_PC_AGILITY
	const BATTLEANIMFRAMESET_PC_SMALL_ROCK_STAR_HEART
	const BATTLEANIMFRAMESET_PC_BIG_GLOW_CLEAR
	const BATTLEANIMFRAMESET_PC_BUBBLE_SPLASH
	const BATTLEANIMFRAMESET_PC_BULK_UP
	const BATTLEANIMFRAMESET_PC_BURNED
	const BATTLEANIMFRAMESET_PC_ICICLE_CRASH
	const BATTLEANIMFRAMESET_PC_CUT_HORIZONTAL
	const BATTLEANIMFRAMESET_PC_LONG_PUNCH
	const BATTLEANIMFRAMESET_PC_MID_GLOW_SHRINKING
	const BATTLEANIMFRAMESET_PC_PULSING_ENERGY_ORB_BIG
	const BATTLEANIMFRAMESET_PC_DRAGON_PULSE
	const BATTLEANIMFRAMESET_PC_MINIMIZE
	const BATTLEANIMFRAMESET_PC_DROPLET_L
	const BATTLEANIMFRAMESET_PC_DROPLET_R
	const BATTLEANIMFRAMESET_PC_10
	const BATTLEANIMFRAMESET_PC_ENERGY_ORB_LONG
	const BATTLEANIMFRAMESET_PC_POISON_DROPLET
	const BATTLEANIMFRAMESET_PC_0F
	const BATTLEANIMFRAMESET_PC_TINY_GLOW
	const BATTLEANIMFRAMESET_PC_FLASH_CANNON_CHARGE_ORB
	const BATTLEANIMFRAMESET_PC_FLASH_CANNON_SPARKS
	const BATTLEANIMFRAMESET_PC_FOCUS_BLAST
	const BATTLEANIMFRAMESET_PC_POISON_JAB
	const BATTLEANIMFRAMESET_PC_GLIMMER
	const BATTLEANIMFRAMESET_PC_RED_STAR
	const BATTLEANIMFRAMESET_PC_GUNK_SHOT
	const BATTLEANIMFRAMESET_PC_INK_SPLASH
	const BATTLEANIMFRAMESET_PC_GYRO_BALL
	const BATTLEANIMFRAMESET_PC_SPARKLE_LONG
	const BATTLEANIMFRAMESET_PC_SPINNING_TRIANGLE
	const BATTLEANIMFRAMESET_PC_HONE_CLAWS_LEFT
	const BATTLEANIMFRAMESET_PC_HONE_CLAWS_RIGHT
	const BATTLEANIMFRAMESET_PC_HURRICANE
	const BATTLEANIMFRAMESET_PC_HYPER_VOICE
	const BATTLEANIMFRAMESET_PC_SPINNING_TRIANGLE_SLOW
	const BATTLEANIMFRAMESET_PC_MEDIUM_HORN
	const BATTLEANIMFRAMESET_PC_MUD_SHOT
	const BATTLEANIMFRAMESET_PC_SMELLINGSALT_SURPRISED
	const BATTLEANIMFRAMESET_PC_POWER_GEM
	const BATTLEANIMFRAMESET_PC_PULSING_SPARKLE
	const BATTLEANIMFRAMESET_PC_BIG_WHIP
	const BATTLEANIMFRAMESET_PC_STONE_EDGE
	const BATTLEANIMFRAMESET_PC_OCTAZOOKA_SMOKE
	const BATTLEANIMFRAMESET_PC_SEED_BOMB
	const BATTLEANIMFRAMESET_PC_SHRINKING_GLOW
	const BATTLEANIMFRAMESET_PC_SHRINKING_RING_BIG
	const BATTLEANIMFRAMESET_PC_SHRINKING_RING_SMALL
	const BATTLEANIMFRAMESET_PC_4C
	const BATTLEANIMFRAMESET_PC_SLOW_GROWING_GLOW
	const BATTLEANIMFRAMESET_PC_SMALL_GLOW
	const BATTLEANIMFRAMESET_PC_SUCKER_PUNCH
	const BATTLEANIMFRAMESET_PC_SWIRL_SHORT
	const BATTLEANIMFRAMESET_PC_TRICK_ROOM
	const BATTLEANIMFRAMESET_PC_VOLT_SWITCH
	const BATTLEANIMFRAMESET_PC_DISCHARGE_SPARKS_N
	const BATTLEANIMFRAMESET_PC_VORTEX
	const BATTLEANIMFRAMESET_PC_WATER_BALL
	const BATTLEANIMFRAMESET_PC_AMNESIA_3_RECOVER
	const BATTLEANIMFRAMESET_PC_DIG_PILE
	const BATTLEANIMFRAMESET_PC_HEART_SHORT
	...
	const BATTLEANIMFRAMESET_PC_GROWING_HEART
; framesets ported from polishedcrystal (batch 2)
	const BATTLEANIMFRAMESET_PC_AQUA_JET
	...
	const BATTLEANIMFRAMESET_PC_44
	const BATTLEANIMFRAMESET_PC_43
	const BATTLEANIMFRAMESET_PC_41
	const BATTLEANIMFRAMESET_PC_40
	const BATTLEANIMFRAMESET_PC_0E
	const BATTLEANIMFRAMESET_PC_18
	const BATTLEANIMFRAMESET_PC_AA
	const BATTLEANIMFRAMESET_PC_7E
	const BATTLEANIMFRAMESET_PC_00
	const BATTLEANIMFRAMESET_PC_01
	const BATTLEANIMFRAMESET_PC_15
	const BATTLEANIMFRAMESET_PC_AB
	const BATTLEANIMFRAMESET_PC_8B
...
; mae-pokeorange ports (2026-07 move expansion animations)
	...
	const BATTLEANIMFRAMESET_ROCK_POLISH_5DEG_R_YFLIP
	const BATTLEANIMFRAMESET_ROCK_POLISH_45DEG_R_YFLIP
	const BATTLEANIMFRAMESET_ROCK_POLISH_85DEG_R_YFLIP
...
; BattleAnimOAMData indexes (see data/battle_anims/oam.asm)
	...
	const BATTLEANIMOAMSET_PC_55
	const BATTLEANIMOAMSET_PC_54
	const BATTLEANIMOAMSET_PC_53
	const BATTLEANIMOAMSET_PC_AC
	const BATTLEANIMOAMSET_PC_0F
	const BATTLEANIMOAMSET_PC_DD
	const BATTLEANIMOAMSET_PC_DC
	const BATTLEANIMOAMSET_PC_20
	const BATTLEANIMOAMSET_PC_EF
	const BATTLEANIMOAMSET_PC_F0
	const BATTLEANIMOAMSET_PC_10
	const BATTLEANIMOAMSET_PC_0E
	const BATTLEANIMOAMSET_PC_0A
	const BATTLEANIMOAMSET_PC_1F
	const BATTLEANIMOAMSET_PC_1E
	const BATTLEANIMOAMSET_PC_E2
	const BATTLEANIMOAMSET_PC_E3
	const BATTLEANIMOAMSET_PC_E4
	const BATTLEANIMOAMSET_PC_E5
	const BATTLEANIMOAMSET_PC_E6
	const BATTLEANIMOAMSET_PC_E7
	const BATTLEANIMOAMSET_PC_E8
	const BATTLEANIMOAMSET_PC_4B
	const BATTLEANIMOAMSET_PC_4C
	const BATTLEANIMOAMSET_PC_4D
	const BATTLEANIMOAMSET_PC_4F
	const BATTLEANIMOAMSET_PC_50
	const BATTLEANIMOAMSET_PC_51
	const BATTLEANIMOAMSET_PC_52
	const BATTLEANIMOAMSET_PC_4E
	const BATTLEANIMOAMSET_PC_EE
	const BATTLEANIMOAMSET_PC_E0
	const BATTLEANIMOAMSET_PC_18
	const BATTLEANIMOAMSET_PC_19
	const BATTLEANIMOAMSET_PC_1A
	const BATTLEANIMOAMSET_PC_00
	const BATTLEANIMOAMSET_PC_07
	const BATTLEANIMOAMSET_PC_C5
	const BATTLEANIMOAMSET_PC_C6
	const BATTLEANIMOAMSET_PC_C7
	const BATTLEANIMOAMSET_PC_BF
	const BATTLEANIMOAMSET_PC_C0
	const BATTLEANIMOAMSET_PC_C1
	const BATTLEANIMOAMSET_PC_F3
	const BATTLEANIMOAMSET_PC_85
	const BATTLEANIMOAMSET_PC_95
	const BATTLEANIMOAMSET_PC_B9
	const BATTLEANIMOAMSET_PC_BD
	const BATTLEANIMOAMSET_PC_01
	const BATTLEANIMOAMSET_PC_HONE_CLAWS_1
	const BATTLEANIMOAMSET_PC_HONE_CLAWS_2
	const BATTLEANIMOAMSET_PC_HONE_CLAWS_3
	const BATTLEANIMOAMSET_PC_HONE_CLAWS_4
	const BATTLEANIMOAMSET_PC_70
	const BATTLEANIMOAMSET_PC_71
	const BATTLEANIMOAMSET_PC_72
	const BATTLEANIMOAMSET_PC_73
	const BATTLEANIMOAMSET_PC_HYPER_VOICE
	const BATTLEANIMOAMSET_PC_E1
	const BATTLEANIMOAMSET_PC_FB
	const BATTLEANIMOAMSET_PC_14
	const BATTLEANIMOAMSET_PC_15
	const BATTLEANIMOAMSET_PC_74
	const BATTLEANIMOAMSET_PC_BIG_WHIP_1
	const BATTLEANIMOAMSET_PC_BIG_WHIP_2
	const BATTLEANIMOAMSET_PC_BIG_WHIP_3
	const BATTLEANIMOAMSET_PC_DF
	const BATTLEANIMOAMSET_PC_DE
	const BATTLEANIMOAMSET_PC_AF
	const BATTLEANIMOAMSET_PC_SWIRL_SHORT_1
	const BATTLEANIMOAMSET_PC_SWIRL_SHORT_2
	const BATTLEANIMOAMSET_PC_SWIRL_SHORT_3
	const BATTLEANIMOAMSET_PC_SWIRL_SHORT_4
	const BATTLEANIMOAMSET_PC_EA
	const BATTLEANIMOAMSET_PC_1D
	const BATTLEANIMOAMSET_PC_EB
	const BATTLEANIMOAMSET_PC_VOLT_SWITCH_1
	const BATTLEANIMOAMSET_PC_DISCHARGE_SPARKS_N_1
	const BATTLEANIMOAMSET_PC_DISCHARGE_SPARKS_N_2
	const BATTLEANIMOAMSET_PC_82
	const BATTLEANIMOAMSET_PC_D9
	const BATTLEANIMOAMSET_PC_DA
	const BATTLEANIMOAMSET_PC_DB
	const BATTLEANIMOAMSET_PC_80
	const BATTLEANIMOAMSET_PC_VOLT_SWITCH_2
	const BATTLEANIMOAMSET_PC_VOLT_SWITCH_3
...
; oam sets ported from polishedcrystal (batch 2)
	const BATTLEANIMOAMSET_PC_BRICK_BREAK
	const BATTLEANIMOAMSET_PC_BUG_BUZZ1
	const BATTLEANIMOAMSET_PC_BUG_BUZZ2
	const BATTLEANIMOAMSET_PC_BULLET_PUNCH
	const BATTLEANIMOAMSET_PC_EC
	const BATTLEANIMOAMSET_PC_F1
	const BATTLEANIMOAMSET_PC_F2
	const BATTLEANIMOAMSET_PC_F6
	const BATTLEANIMOAMSET_PC_F7
	const BATTLEANIMOAMSET_PC_F8
	const BATTLEANIMOAMSET_PC_F9
	const BATTLEANIMOAMSET_PC_FA
	const BATTLEANIMOAMSET_PC_FC
	const BATTLEANIMOAMSET_PC_ICICLE_CRASH
	const BATTLEANIMOAMSET_PC_MUSHROOM_1
	const BATTLEANIMOAMSET_PC_MUSHROOM_2
	const BATTLEANIMOAMSET_PC_MUSHROOM_3
...
; mae-pokeorange ports (2026-07 move expansion animations)
	...
	const BATTLEANIMOAMSET_ROCK_POLISH_5DEG_1
	const BATTLEANIMOAMSET_ROCK_POLISH_5DEG_2
	const BATTLEANIMOAMSET_ROCK_POLISH_5DEG_3
	const BATTLEANIMOAMSET_ROCK_POLISH_5DEG_4
	const BATTLEANIMOAMSET_ROCK_POLISH_45DEG_1
	const BATTLEANIMOAMSET_ROCK_POLISH_45DEG_2
	const BATTLEANIMOAMSET_ROCK_POLISH_45DEG_3
	const BATTLEANIMOAMSET_ROCK_POLISH_85DEG_1
...
OAMDOWAIT_COMMAND   EQU $fdff
OAMRESTART_COMMAND  EQU $feff
OAMENDANIM_COMMAND  EQU $ffff
...
; gfx ported from polishedcrystal (batch 2)
...
; the first 6 match PAL_BATTLE_OB_GRAY/YELLOW/...
	...
	const PAL_BTLCUSTOM_HEAT_WAVE        ; 3a
NUM_CUSTOM_BATTLE_PALETTES EQU const_value

PAL_BTLCUSTOM_DEFAULT EQU $ff

; polishedcrystal-compatible aliases (ported move animations)
ANIM_BG_CYCLE_OBPALS_GRAY_AND_YELLOW_FULL_SHIFT EQU ANIM_BG_08
ANIM_BG_FADE_MON_TO_LIGHT EQU ANIM_BG_16
ANIM_BG_FADE_MON_TO_BLACK EQU ANIM_BG_17
ANIM_BG_FLASH_MON_REPEATING EQU ANIM_BG_1B
ANIM_BG_FADE_MONS_TO_BLACK_REPEATING EQU ANIM_BG_1C
ANIM_BG_FADE_MON_TO_WHITE_WAIT_FADE_BACK EQU ANIM_BG_1D
ANIM_BG_FADE_MON_FROM_WHITE EQU ANIM_BG_1E
ANIM_BG_BODY_SLAM EQU ANIM_BG_25
ANIM_BG_WAVE_DEFORM_MON EQU ANIM_BG_WAVE_DEFORM_USER
ANIM_BG_BETA_SEND_OUT_MON1 EQU ANIM_BG_2A
ANIM_BG_BETA_SEND_OUT_MON2 EQU ANIM_BG_2B
ANIM_BG_FLAIL EQU ANIM_BG_2C
ANIM_BG_PURSUIT EQU ANIM_BG_2D
ANIM_BG_ROLLOUT EQU ANIM_BG_2E
ANIM_BG_VITAL_THROW EQU ANIM_BG_2F
ANIM_BG_START_WATER EQU ANIM_BG_30
ANIM_BG_WATER EQU ANIM_BG_31
ANIM_BG_END_WATER EQU ANIM_BG_32
ANIM_BG_WOBBLE_SCREEN EQU ANIM_BG_35
PAL_BATTLE_BG_EXP_GENDER EQU PAL_BATTLE_BG_EXP
PAL_BATTLE_BG_STATUS EQU PAL_BATTLE_BG_5
PAL_BATTLE_BG_TYPE_CAT EQU PAL_BATTLE_BG_6
