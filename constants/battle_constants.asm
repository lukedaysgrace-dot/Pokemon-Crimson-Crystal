...
BATTLERESULT_CAUGHT EQU 6 ; set by PokeBallEffect on any successful wild catch
BATTLERESULT_CAUGHT_CELEBI EQU 6 ; legacy name for the same bit (GS Ball event)
