...
NICKNAMED_MON_STRUCT_LENGTH EQUS "(PARTYMON_STRUCT_LENGTH + STORED_MON_NAME_LENGTH)"
...
; hall of fame
HOF_MON_LENGTH EQU 2 + 2 + 2 + 1 + (STORED_MON_NAME_LENGTH + -1) ; species, id, dvs, level, nick
...
SAFARI_ZONE_NO_ENCOUNTER_BLOCK EQU $01
