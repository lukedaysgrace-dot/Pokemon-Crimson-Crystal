...
; Fossils hidden in the Ruins of Alph Aerodactyl word room.
	const EVENT_AERODACTYL_WORD_ROOM_DOME_WALL_OPEN
	const EVENT_AERODACTYL_WORD_ROOM_HELIX_WALL_OPEN
	const EVENT_AERODACTYL_WORD_ROOM_ARMOR_WALL_OPEN
	const EVENT_PICKED_UP_DOME_FOSSIL_FROM_AERODACTYL_WORD_ROOM
	const EVENT_PICKED_UP_HELIX_FOSSIL_FROM_AERODACTYL_WORD_ROOM
