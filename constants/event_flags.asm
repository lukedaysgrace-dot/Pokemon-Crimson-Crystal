...
; Picnicker
	...
	const EVENT_BEAT_AROMA_LADY_KIM
	const EVENT_BEAT_PICNICKER_CINDY
	const EVENT_BEAT_AROMA_LADY_HOPE
	const EVENT_BEAT_AROMA_LADY_SHARON
	const EVENT_BEAT_AROMA_LADY_DEBRA
	...
	const EVENT_BEAT_AROMA_LADY_HEIDI
	const EVENT_BEAT_AROMA_LADY_EDNA
	...
	const EVENT_BEAT_AROMA_LADY_TANYA
...
; New to Crystal
	...
	const EVENT_BEAT_AROMA_LADY_NADIA
