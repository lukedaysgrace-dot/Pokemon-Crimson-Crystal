...
SWITCH_ABILITIES   EQU 1 << SWITCH_ABILITIES_F ; ability-aware switch AI (see engine/battle/ai/switch.asm)
...
TRAINERTYPE_MOVES_ABILITY EQU TRAINERTYPE_MOVES | TRAINERTYPE_ABILITY
TRAINERTYPE_ITEM_MOVES_ABILITY EQU TRAINERTYPE_MOVES | TRAINERTYPE_ITEM | TRAINERTYPE_ABILITY
