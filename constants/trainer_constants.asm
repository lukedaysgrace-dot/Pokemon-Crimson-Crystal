...
LYRA EQU __enum__
	...
	const CRYSTAL_2_CHIKORITA
	const CRYSTAL_2_CYNDAQUIL
	const CRYSTAL_2_TOTODILE
	const CRYSTAL_3_CHIKORITA
	const CRYSTAL_3_CYNDAQUIL
	const CRYSTAL_3_TOTODILE
	const CRYSTAL_4_CHIKORITA
	const CRYSTAL_4_CYNDAQUIL
	const CRYSTAL_4_TOTODILE
	const CRYSTAL_5_CHIKORITA
	const CRYSTAL_5_CYNDAQUIL
