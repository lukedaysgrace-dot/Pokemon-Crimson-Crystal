...
check(h.rd(0xFF45) in (71, 72, 87, 88, 103, 104, 119, 120, 135, 136), f"LYC in icon rows (got {h.rd(0xFF45)})")
check(h.rd(0xFF41) & 0x78 == 0x40, f"STAT = LYC interrupt only (got {h.rd(0xFF41):02x})")
